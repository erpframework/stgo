<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Add" Theme="wdCalendar" %>
...
<body>
    <div>      
      ...
      <div class="infocontainer">            
        <form action="datafeed.aspx?method=adddetails" class="fform" id="fmEdit" method="post">                 
          <label>                    
            <span>*Subject:</span>                    
