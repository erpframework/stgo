<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Edit" Theme="wdCalendar" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#hypViewLead").click(function() { CloseModelWindow(); });
            $("#Savebtn").click(function() { $("#fmEdit").submit(); });
            $("#Closebtn").click(function() { CloseModelWindow(); });
            $("#Deletebtn").click(function() {
                var calID = $.getQueryParam("id");
...
<body>
    <div>      
      ...
      <div class="infocontainer">            
        <form action='datafeed.aspx?method=adddetails&Id=<%=(Request["id"] == null ? "" : Request["id"]) %>' class="fform" id="fmEdit" method="post">                 
          <label>                    
            <span>*Subject:</span>                    
            <div id="calendarcolor">
            </div>
            <input MaxLength="200" class="required safe" id="Subject" name="Subject" style="width:85%;" type="text" value='<%=dtRow["Subject"] %>' />                     
          ...
          <label>                    
            ...
            <div>               
              <input MaxLength="10" class="required date" id="stpartdate" name="stpartdate" style="padding-left:2px;width:90px;" type="text" value='<%=sSD %>' />                       
              <input MaxLength="5" class="required time" id="stparttime" name="stparttime" style="width:40px;" type="text" value='<%=sST %>' />To                       
          ...
          <label>                    
            <span>Location:</span>                    
            <input MaxLength="200" id="Location" name="Location" style="width:95%;" type="text" value='<%=dtRow["Location"] %>' />                 
          </label>                 
          <label>                    
            <span>Remark:</span>                    
            <textarea cols="20" id="Description" name="Description" rows="2" style="width:95%; height:70px"><%=dtRow["Description"] %></textarea>                
          </label>                
